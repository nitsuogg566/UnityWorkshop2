...
public class OvrAvatar : MonoBehaviour {
    ...
    {
        ovrAvatarComponent component = Oculus.Avatar.CAPI.ovrAvatarComponent_Get(sdkAvatar, projectorRender.componentIndex);
    ...
    void AvatarSpecificationCallback(IntPtr avatarSpecification) {
        ...
        UInt32 assetCount = Oculus.Avatar.CAPI.ovrAvatar_GetReferencedAssetCount(sdkAvatar);
        for (UInt32 i = 0; i < assetCount; ++i)
        {
            UInt64 id = Oculus.Avatar.CAPI.ovrAvatar_GetReferencedAsset(sdkAvatar, i);
    ...
    void Start() {
        ...
        OvrAvatarSDKManager.Instance.RequestAvatarSpecification(
            295109307540267, this.AvatarSpecificationCallback);
    }
